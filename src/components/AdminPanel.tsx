  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 overflow-y-auto scrollbar-thin p-6 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h2 className="text-2xl font-bold text-white mb-2">Painel Administrativo SDR</h2>
            <p className="text-slate-400 text-sm">Visão geral de performance, configuração da IA e regras de negócio.</p>
        </div>
